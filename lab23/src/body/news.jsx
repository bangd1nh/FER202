            ...
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                        ...
                        <h2 class="display-5 mb-4 mb-md-5 text-center">Here is our news's latest company news about regularly publishing fresh content.</h2>
                        ...
                        <article>
                            <div class="card border-0">
                                <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                                    <a href="#!">
                                        <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src={require('../assets/person-1.jpg')} alt="Business" />
                                    </a>
                                    <figcaption>
                    ...
                    <div class="col-12 col-lg-4">
                        <article>
                            <div class="card border-0">
                                <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                                    <a href="#!">
                                        <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src={require('../assets/person-2.jpg')} alt="Nutrition" />
                                    </a>
                                    <figcaption>
                    ...
                    <div class="col-12 col-lg-4">
                        <article>
                            <div class="card border-0">
                                <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                                    <a href="#!">
                                        <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src={require('../assets/person-3.jpg')} alt="Health" />
                                    </a>
                                    <figcaption>
